...
import { updatePairDayData, updateTokenDayData, updateSpiritswapDayData, updatePairHourData } from "./dayUpdates";
...
export function handleSwap(event: Swap): void {
  ...
  let pancakeDayData = updateSpiritswapDayData(event);
